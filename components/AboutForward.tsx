      ...
      <Container>
        <div className="grid lg:grid-cols-[1.2fr_1fr] gap-12 lg:gap-20 items-start">
          <div className="flex flex-col gap-6">
            ...
            <h2 className="font-arabic font-bold text-navy text-3xl sm:text-4xl lg:text-[2.6rem] leading-[1.75] balance">
              فُورْوَرْد هي منظومة تعليمية وتنموية ترافق الطالب في أهم مراحل رحلته التعليمية، من لحظة اختيار التخصص، إلى الاستعداد للحياة الجامعية، ثم التميز داخل الجامعة، وصولًا إلى ما بعد التخرج وبداية المسار المهني.
            </h2>
          </div>

          <div className="flex flex-col gap-7 lg:pt-3">
            <p className="text-lg leading-[1.4] text-ink-soft balance">
